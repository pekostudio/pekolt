  ...
  return (
    <section className="skills">
      ...
      <div className="skillsCenter">
        ...
        <p>Development <br /><br /> Php, HTML5, CSS3, JavaScript, AJAX, XML, jQuery, React, VueJs, Webpack, Gatsby, Jekyll, JAMstack sites, Bootstrap, Foundation, Headless CMS, Strapi, Netlify, Contentful and others. Knowledge ‘fundamentals of server side coding’.</p>
      </div>
